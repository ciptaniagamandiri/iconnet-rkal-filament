...
<div class="max-w-7xl mx-auto py-10 px-5">
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3 place-content-center">
        ...
        <!-- Whatsapp -->
        <a href="https://wa.me/6281112002123" target="_blank" class="p-4 bg-gray-100 rounded-xl flex items-center space-x-4 group hover:bg-brands-primary overflow-hidden">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 lg:w-20 text-gray-500 group-hover:text-white flex-shrink-0" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <h1 class="text-lg lg:text-2xl font-medium text-gray-900 group-hover:text-white">0811-1200-2123</h1>
            </div>
        </a>
        <!-- Instagram -->
        <a href="https://www.instagram.com/iconnet.care/" target="_blank" class="p-4 bg-gray-100 rounded-xl flex items-center space-x-4 group hover:bg-brands-primary overflow-hidden">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 lg:w-20 text-gray-500 group-hover:text-white flex-shrink-0" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <h1 class="text-lg lg:text-2xl font-medium text-gray-900 group-hover:text-white">@iconnet.care</h1>
            </div>
        </a>
        <!-- Email -->
        <a href="mailto:cc.iconnet@iconpln.co.id" class="p-4 bg-gray-100 rounded-xl flex items-center space-x-4 group hover:bg-brands-primary overflow-hidden">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 lg:w-20 text-gray-500 group-hover:text-white flex-shrink-0" viewBox="0 0 24 24">
